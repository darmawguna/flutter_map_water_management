...
import 'package:waterspring/controllers/main_controller.dart';
import 'package:waterspring/conts/images.dart';
import 'package:waterspring/conts/strings.dart';
import 'package:waterspring/models/current_weather_model.dart';
import 'package:waterspring/models/hourly_weather_model.dart';
...
class _WeatherAppState extends State<WeatherApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: date.text.color(black80).make(),
